...
<div class="form-group cusPaymentSec">
	...
	<div class="paymentSelect">
		<?php if ( '' != $wpep_square_payment_box_1 ) { ?>
			<div class="selection">
				<input id="doller1_<?php echo esc_html( $wpep_current_form_id ); ?>" name="doller"
					   type="radio" 
					   <?php
						...
						?>
						 />
				<label for="doller1_<?php echo esc_html( $wpep_current_form_id ); ?>" class="paynow">
					<?php if ( $currencySymbolType == 'symbol' ) { ?>
						<?php echo esc_html( $square_currency ) . esc_html( $wpep_square_payment_box_1 ); ?>
					<?php } else { ?>
						<?php echo esc_html( $wpep_square_payment_box_1 ) . ' ' . esc_html( $square_currency ); ?>
					<?php } ?>
				</label>
			</div>
		<?php } ?>
		<?php if ( '' != $wpep_square_payment_box_2 ) { ?>
			<div class="selection">
				<input id="doller2_<?php echo esc_html( $wpep_current_form_id ); ?>" name="doller"
					   type="radio" 
					   <?php
						...
						?>
						 />
				<label for="doller2_<?php echo esc_html( $wpep_current_form_id ); ?>" class="paynow">
					<?php if ( $currencySymbolType == 'symbol' ) { ?>
						<?php echo esc_html( $square_currency ) . esc_html( $wpep_square_payment_box_2 ); ?>
					<?php } else { ?>
						<?php echo esc_html( $wpep_square_payment_box_2 ) . ' ' . esc_html( $square_currency ); ?>
					<?php } ?>
				</label>
			</div>
		<?php } ?>
		<?php if ( '' != $wpep_square_payment_box_3 ) { ?>
			<div class="selection">
				<input id="doller5_<?php echo esc_html( $wpep_current_form_id ); ?>" name="doller"
					   type="radio" 
					   <?php
						...
						?>
						 />
				<label for="doller5_<?php echo esc_html( $wpep_current_form_id ); ?>" class="paynow">
					<?php if ( $currencySymbolType == 'symbol' ) { ?>
						<?php echo esc_html( $square_currency ) . esc_html( $wpep_square_payment_box_3 ); ?>
					<?php } else { ?>
						<?php echo esc_html( $wpep_square_payment_box_3 ) . ' ' . esc_html( $square_currency ); ?>
					<?php } ?>
				</label>
			</div>
		<?php } ?>
		<?php if ( '' != $wpep_square_payment_box_4 ) { ?>
			<div class="selection">
				<input id="doller10_<?php echo esc_html( $wpep_current_form_id ); ?>" name="doller"
					   type="radio" 
					   <?php
						...
						?>
						 />
				<label for="doller10_<?php echo esc_html( $wpep_current_form_id ); ?>" class="paynow">
					<?php if ( $currencySymbolType == 'symbol' ) { ?>
						<?php echo esc_html( $square_currency ) . esc_html( $wpep_square_payment_box_4 ); ?>
					<?php } else { ?>
						<?php echo esc_html( $wpep_square_payment_box_4 ) . ' ' . esc_html( $square_currency ); ?>
					<?php } ?>
				</label>
			</div>
		<?php } ?>
		...
		if ( $wpep_square_user_defined_amount == 'on' ) {
			...
			<div class="selection">
				<input id="doller3_<?php echo esc_html( $wpep_current_form_id ); ?>" name="doller"
	 ...
	 >
		<div class="otherpInput">
			...
			<input class="form-control text-center customPayment otherPayment"
				   Placeholder="Enter your amount <?php echo esc_html( $wpep_square_payment_min ); ?> - <?php echo esc_html( $wpep_square_payment_max ); ?>"
				   name="somename" min="<?php echo esc_attr( $wpep_square_payment_min ); ?>"
				   max="<?php echo esc_attr( $wpep_square_payment_max ); ?>" type="text"/>
