...
<main>
	...
	<div class="form-group">
		...
		<textarea type="text" class="form-control form-control-textarea" placeholder="Please Enter popup description" name="wpep_transaction_notes_box" spellcheck="false"> <?php echo esc_textarea( $selected_transaction_notes ); ?> </textarea>
	</div>
	<div class="note">
