...
jQuery( document ).ready(
	function () {
		...
		if (jQuery( '#on-off-single' ).is( ":checked" )) {
			...
			jQuery( "#wpep_spmst" ).removeClass( 'testActive' );
			jQuery( "#wpep_spmsl" ).addClass( 'liveActive' );

		} else {

			jQuery( "#wpep_spmst" ).addClass( 'testActive' );
			jQuery( "#wpep_spmsl" ).removeClass( 'liveActive' );
...
jQuery( '#paymentTypeSel' ).change(
	function () {
		...
		if (this.value == 'donation_recurring') {
